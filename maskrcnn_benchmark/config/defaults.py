...
_C.MODEL.RPN.N_LOGIT_PER_ANCHOR = 1
_C.MODEL.RPN.MID_CHANNELS = 256
...
_C.MODEL.ROI_BOX_HEAD.POST_PROCESSOR = "PostProcessor"
...
_C.MODEL.ROI_BOX_HEAD.NUM_CLASSES_ATTR = 401
